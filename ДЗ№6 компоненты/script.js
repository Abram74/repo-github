...
Vue.component('goods-item', {
    ...
    template: `
      <div class="goods-item">
        ...
        <p>{{ good.price }}</p>
        <button class="cart-button" type="button" v-on:click="toCart($event)">Купить</button>
      </div>
    `
});

//Выносим корзину в отдельный компонент
Vue.component('vue-cart', {
    template: `<div class="cart"></div>`
});

//Выносим строку поиска и кнопку поиска в отдельный компонент
